    ...
    <section className="py-30 text-white bg-[rgba(37,81,86,1)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="font-montserrat text-3xl sm:text-4xl lg:text-[41px] font-bold mb-6 leading-[54px]">Corporate Incentive Travel</h2>
                      <p className="font-karla text-lg sm:text-xl text-slate-300 max-w-3xl mx-auto">
